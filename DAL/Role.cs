...
namespace Maticsoft.DAL
{
	...
	public partial class Role
	{
		...
		public int Add(Maticsoft.Model.Role model)
		{
			...
			strSql.Append("Name,PrivilegeID,APPName)");
			strSql.Append(" values (");
			strSql.Append("@Name,@PrivilegeID,@APPName)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@Name", SqlDbType.NVarChar,50),
					new SqlParameter("@PrivilegeID", SqlDbType.NVarChar,500),
					new SqlParameter("@APPName", SqlDbType.NVarChar,50)};
			parameters[0].Value = model.Name;
			parameters[1].Value = model.PrivilegeID;
		...
		public Maticsoft.Model.Role GetModel(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,Name,PrivilegeID,APPName from Role ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,Name,PrivilegeID,APPName ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,Name,PrivilegeID,APPName ");
			strSql.Append(" FROM Role ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
